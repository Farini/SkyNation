                    ...
                    VStack(alignment: .leading, spacing:6) {
                        ...
                        Group {
                            Group {
                                ...
                                Text("Resources displays the items the Station has. Here the player can manage their tanks and have control over the air in the space station.")
                            }
                            
                            Group {
                                Text("Machinery").font(.title3).foregroundColor(.orange)
                                Text("The player should regularly fix their peripherals. When broken, a peripheral consumes energy, and fails to produce results.")
                        ...
                        Group {
                            Group {
                                ...
                                Text("Players should make sure their station does not run out of energy. Otherwise peripherals will not work and the astronauts will get upset.")
                                Text("System").font(.title3).foregroundColor(.orange)
                                Text("System displays accounting reports generated by the Station.")
                                Text("Use the 'waste' intelligently. The player can accumulate some liquid waste, to be transformed in water. Good waste control keeps the progress bars about half-full.")
                            }
                            Divider()
                            Group {
                                Text("Report").font(GameFont.section.makeFont())
                                Text("The report indicates how well the space station is doing.")
                                Text("In the 'issues' section, a player can see which peripherals are broken, and if some ingredients could not find a spot to be stored.")
                                Text("In the 'Machinery' section, a player sees how much each peripheral consumed/produced in the last hour.")
                                Text("Under 'Astronauts', a player may see how well each astronaut is doing.")
                                Text("😷 = Health")
                                Text("😃 = Happiness")
                                Text("❤️ = Life expectancy")
                                Text("Numbers after the delta (𝚫) symbol indicate whether they are moving up or down.")
                            }
            ...
            case .OrderView:
                ScrollView {
                    VStack(alignment:.leading, spacing:6) {
                        ...
                        Text("Order").font(GameFont.section.makeFont()).foregroundColor(.blue)
                        Divider()
                        
                        Group {
                            
                            Group {
                                Text("A player may order Boxes of Ingredients, Tanks, and hire Astronauts here.")
                                ...
                                Text("Every order has a fixed price (delivery fees), plus the price of the goods. Filling a cart all the way is very important, to avoid wasting Sky Coins.")
                            }
                            
                            Group {
                                Text("Crowded Astronauts").font(GameFont.section.makeFont()).foregroundColor(.red)
                        ...
                        Group {
                            Text("Waste Management").font(GameFont.section.makeFont()).foregroundColor(.yellow)
                            Text("Using liquid waste and solid waste offers a chance for the player to make their space station sustainable. A water filter peripheral can reccycle the water, while a methanizer can recycle solid waste.")
                            
                            Text("Food, Oxygen, and Water").font(GameFont.section.makeFont()).foregroundColor(.blue)
                            Text("The essentials for astronaut survival can be found here. Make good use of them.")
                        }
                    }
                    .fixedSize(horizontal: false, vertical: true)
                    .padding(8)
